// $ANTLR 3.5.2 ./src/VSLParser.g 2016-11-18 15:29:13
...
public class VSLParser extends Parser {
	...
	public final VSLParser.function_return function() throws RecognitionException {
		...
		try {
			...
			// AST REWRITE
			// elements: statement, param_list, type, FUNC_KW, IDENT
			// token labels: 
			// rule labels: retval
			// token list labels: 
			// rule list labels: 
	...
	public final VSLParser.expression_return expression() throws RecognitionException {
		...
		try {
			...
			pushFollow(FOLLOW_factor_in_expression639);
			factor68=factor();
			state._fsp--;
				...
				case 1 :
					...
					switch (alt12) {
						case 1 :
							...
							{
							PLUS69=(Token)match(input,PLUS,FOLLOW_PLUS_in_expression643); 
						...
						case 2 :
							...
							{
							MINUS70=(Token)match(input,MINUS,FOLLOW_MINUS_in_expression646); 
					...
					pushFollow(FOLLOW_factor_in_expression650);
					factor71=factor();
					state._fsp--;
	...
	public final VSLParser.factor_return factor() throws RecognitionException {
		...
		try {
			...
			pushFollow(FOLLOW_primary_in_factor669);
			primary72=primary();
			state._fsp--;
				...
				case 1 :
					...
					switch (alt14) {
						case 1 :
							...
							{
							MUL73=(Token)match(input,MUL,FOLLOW_MUL_in_factor673); 
						...
						case 2 :
							...
							{
							DIV74=(Token)match(input,DIV,FOLLOW_DIV_in_factor676); 
					...
					pushFollow(FOLLOW_primary_in_factor680);
					primary75=primary();
					state._fsp--;
		...
		try {
			...
			switch (alt17) {
				case 1 :
					...
					INTEGER76=(Token)match(input,INTEGER,FOLLOW_INTEGER_in_primary699); 
				...
				case 2 :
					...
					IDENT77=(Token)match(input,IDENT,FOLLOW_IDENT_in_primary707); 
				...
				case 3 :
					...
					pushFollow(FOLLOW_array_elem_in_primary715);
				...
				case 4 :
					...
					{
					IDENT79=(Token)match(input,IDENT,FOLLOW_IDENT_in_primary723);  
					stream_IDENT.add(IDENT79);

					LP80=(Token)match(input,LP,FOLLOW_LP_in_primary725);  
					stream_LP.add(LP80);
					...
					switch (alt16) {
						case 1 :
							// ./src/VSLParser.g:88:16: argument_list
							{
							pushFollow(FOLLOW_argument_list_in_primary727);
					...
					RP82=(Token)match(input,RP,FOLLOW_RP_in_primary730);  
					stream_RP.add(RP82);
				...
				case 5 :
					...
					LP83=(Token)match(input,LP,FOLLOW_LP_in_primary749); 
					pushFollow(FOLLOW_expression_in_primary752);
					expression84=expression();
					state._fsp--;

					adaptor.addChild(root_0, expression84.getTree());

					RP85=(Token)match(input,RP,FOLLOW_RP_in_primary754); 
					}
					break;
				case 6 :
					// ./src/VSLParser.g:90:7: MINUS primary
					{
					MINUS86=(Token)match(input,MINUS,FOLLOW_MINUS_in_primary763);  
					stream_MINUS.add(MINUS86);

					pushFollow(FOLLOW_primary_in_primary765);
					primary87=primary();
					state._fsp--;
	...
	public final VSLParser.argument_list_return argument_list() throws RecognitionException {
		...
		try {
			...
			pushFollow(FOLLOW_expression_in_argument_list790);
			...
			while (true) {
				...
				case 1 :
					...
					{
					COM89=(Token)match(input,COM,FOLLOW_COM_in_argument_list793); 
					pushFollow(FOLLOW_expression_in_argument_list796);
	...
	public final VSLParser.print_list_return print_list() throws RecognitionException {
		...
		try {
			...
			pushFollow(FOLLOW_print_item_in_print_list815);
			...
			while (true) {
				...
				case 1 :
					...
					{
					COM92=(Token)match(input,COM,FOLLOW_COM_in_print_list818); 
		...
		try {
			...
			switch (alt20) {
				case 1 :
					...
					TEXT94=(Token)match(input,TEXT,FOLLOW_TEXT_in_print_item840); 
				...
				case 2 :
					...
					pushFollow(FOLLOW_expression_in_print_item848);
	...
	public final VSLParser.read_list_return read_list() throws RecognitionException {
		...
		try {
			...
			pushFollow(FOLLOW_read_item_in_read_list865);
			...
			while (true) {
				...
				case 1 :
					...
					{
					COM97=(Token)match(input,COM,FOLLOW_COM_in_read_list868); 
					pushFollow(FOLLOW_read_item_in_read_list871);
		...
		try {
			...
			switch (alt22) {
				case 1 :
					...
					IDENT99=(Token)match(input,IDENT,FOLLOW_IDENT_in_read_item890); 
				...
				case 2 :
					...
					pushFollow(FOLLOW_array_elem_in_read_item898);
		...
		try {
			...
			while (true) {
				...
				case 1 :
					...
					{
					INT_KW101=(Token)match(input,INT_KW,FOLLOW_INT_KW_in_declaration916);  
					stream_INT_KW.add(INT_KW101);

					pushFollow(FOLLOW_decl_list_in_declaration918);
	...
	public final VSLParser.decl_list_return decl_list() throws RecognitionException {
		...
		try {
			...
			pushFollow(FOLLOW_decl_item_in_decl_list949);
			...
			while (true) {
				...
				case 1 :
					...
					{
					COM104=(Token)match(input,COM,FOLLOW_COM_in_decl_list952); 
					pushFollow(FOLLOW_decl_item_in_decl_list955);
		...
		try {
			...
			switch (alt25) {
				case 1 :
					...
					IDENT106=(Token)match(input,IDENT,FOLLOW_IDENT_in_decl_item974); 
				...
				case 2 :
					...
					{
					IDENT107=(Token)match(input,IDENT,FOLLOW_IDENT_in_decl_item982);  
					stream_IDENT.add(IDENT107);

					LB108=(Token)match(input,LB,FOLLOW_LB_in_decl_item984);  
					stream_LB.add(LB108);

					INTEGER109=(Token)match(input,INTEGER,FOLLOW_INTEGER_in_decl_item986);  
					stream_INTEGER.add(INTEGER109);

					RB110=(Token)match(input,RB,FOLLOW_RB_in_decl_item988);  
					stream_RB.add(RB110);
	...
	public static final BitSet FOLLOW_factor_in_expression639 = new BitSet(new long[]{0x0000000002400002L});
	public static final BitSet FOLLOW_PLUS_in_expression643 = new BitSet(new long[]{0x0000000000614000L});
	public static final BitSet FOLLOW_MINUS_in_expression646 = new BitSet(new long[]{0x0000000000614000L});
	public static final BitSet FOLLOW_factor_in_expression650 = new BitSet(new long[]{0x0000000002400002L});
	public static final BitSet FOLLOW_primary_in_factor669 = new BitSet(new long[]{0x0000000000800202L});
	public static final BitSet FOLLOW_MUL_in_factor673 = new BitSet(new long[]{0x0000000000614000L});
	public static final BitSet FOLLOW_DIV_in_factor676 = new BitSet(new long[]{0x0000000000614000L});
	public static final BitSet FOLLOW_primary_in_factor680 = new BitSet(new long[]{0x0000000000800202L});
	public static final BitSet FOLLOW_INTEGER_in_primary699 = new BitSet(new long[]{0x0000000000000002L});
	public static final BitSet FOLLOW_IDENT_in_primary707 = new BitSet(new long[]{0x0000000000000002L});
	public static final BitSet FOLLOW_array_elem_in_primary715 = new BitSet(new long[]{0x0000000000000002L});
	public static final BitSet FOLLOW_IDENT_in_primary723 = new BitSet(new long[]{0x0000000000200000L});
	public static final BitSet FOLLOW_LP_in_primary725 = new BitSet(new long[]{0x0000000100614000L});
	public static final BitSet FOLLOW_argument_list_in_primary727 = new BitSet(new long[]{0x0000000100000000L});
	public static final BitSet FOLLOW_RP_in_primary730 = new BitSet(new long[]{0x0000000000000002L});
	public static final BitSet FOLLOW_LP_in_primary749 = new BitSet(new long[]{0x0000000000614000L});
	public static final BitSet FOLLOW_expression_in_primary752 = new BitSet(new long[]{0x0000000100000000L});
	public static final BitSet FOLLOW_RP_in_primary754 = new BitSet(new long[]{0x0000000000000002L});
	public static final BitSet FOLLOW_MINUS_in_primary763 = new BitSet(new long[]{0x0000000000614000L});
	public static final BitSet FOLLOW_primary_in_primary765 = new BitSet(new long[]{0x0000000000000002L});
	public static final BitSet FOLLOW_expression_in_argument_list790 = new BitSet(new long[]{0x0000000000000042L});
	public static final BitSet FOLLOW_COM_in_argument_list793 = new BitSet(new long[]{0x0000000000614000L});
	public static final BitSet FOLLOW_expression_in_argument_list796 = new BitSet(new long[]{0x0000000000000042L});
	public static final BitSet FOLLOW_print_item_in_print_list815 = new BitSet(new long[]{0x0000000000000042L});
	public static final BitSet FOLLOW_COM_in_print_list818 = new BitSet(new long[]{0x0000000200614000L});
	public static final BitSet FOLLOW_print_item_in_print_list821 = new BitSet(new long[]{0x0000000000000042L});
	public static final BitSet FOLLOW_TEXT_in_print_item840 = new BitSet(new long[]{0x0000000000000002L});
	public static final BitSet FOLLOW_expression_in_print_item848 = new BitSet(new long[]{0x0000000000000002L});
	public static final BitSet FOLLOW_read_item_in_read_list865 = new BitSet(new long[]{0x0000000000000042L});
	public static final BitSet FOLLOW_COM_in_read_list868 = new BitSet(new long[]{0x0000000000004000L});
	public static final BitSet FOLLOW_read_item_in_read_list871 = new BitSet(new long[]{0x0000000000000042L});
	public static final BitSet FOLLOW_IDENT_in_read_item890 = new BitSet(new long[]{0x0000000000000002L});
	public static final BitSet FOLLOW_array_elem_in_read_item898 = new BitSet(new long[]{0x0000000000000002L});
	public static final BitSet FOLLOW_INT_KW_in_declaration916 = new BitSet(new long[]{0x0000000000004000L});
	public static final BitSet FOLLOW_decl_list_in_declaration918 = new BitSet(new long[]{0x0000000000020002L});
	public static final BitSet FOLLOW_decl_item_in_decl_list949 = new BitSet(new long[]{0x0000000000000042L});
	public static final BitSet FOLLOW_COM_in_decl_list952 = new BitSet(new long[]{0x0000000000004000L});
	public static final BitSet FOLLOW_decl_item_in_decl_list955 = new BitSet(new long[]{0x0000000000000042L});
	public static final BitSet FOLLOW_IDENT_in_decl_item974 = new BitSet(new long[]{0x0000000000000002L});
	public static final BitSet FOLLOW_IDENT_in_decl_item982 = new BitSet(new long[]{0x0000000000040000L});
	public static final BitSet FOLLOW_LB_in_decl_item984 = new BitSet(new long[]{0x0000000000010000L});
	public static final BitSet FOLLOW_INTEGER_in_decl_item986 = new BitSet(new long[]{0x0000000010000000L});
	public static final BitSet FOLLOW_RB_in_decl_item988 = new BitSet(new long[]{0x0000000000000002L});
}
